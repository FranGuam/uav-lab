...
class JudgeNode:
    ...
    def __init__(self):
        ...
        self.ros_path_ = getPackagePath('hector_quadrotor_demo')
        self.readYaml()
        ...
        self.poseSub_ = rospy.Subscriber('/ground_truth/state', Odometry, self.poseCallback)
    ...
    def poseCallback(self, msg):
        ...
        if pose.position.z < 0.2 and pose.position.x > 6 and pose.position.x < 8 and pose.position.y > 13.2 and pose.position.y < 15.2:
